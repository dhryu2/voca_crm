...
public interface MemberRepository extends JpaRepository<Member, UUID> {
     ...
     */
    @Modifying
    @Query("UPDATE Member m SET m.ownerId = null WHERE m.ownerId = :userId")
     ...
     */
    @Modifying
    @Query("UPDATE Member m SET m.lastModifiedById = null WHERE m.lastModifiedById = :userId")
     ...
     */
    @Modifying
    @Query("UPDATE Member m SET m.deletedBy = null WHERE m.deletedBy = :userId")
